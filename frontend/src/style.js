export const styles = {
  ...
  header: {
    ...
    padding: '30px', background: '#fff', borderBottom: '1px solid #eaeaea'
  },
  title: { fontSize: '2rem', fontWeight: 'bold', color: '#234567' },
  deployBtn: {
  ...
  uploadTitle: { margin: 0, fontSize: '1.2rem', color: '#556789', fontWeight: '600' },
  fileInput: { marginRight: '16px', marginTop: '10px' },
  uploadBtn: {
    background: '#e0e3ff', color: '#2e3467', border: 'none',
